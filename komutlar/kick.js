...
var prefix = ayarlar.prefix;             
  ...
  if (!message.member.permissions.has("KICK_MEMBERS")) return message.channel.send(`Knk yetkili değilsin`);
  ...
  if (message.mentions.users.size < 1) return message.channel.send(`Sunucudan yollamam için suçluyu etiketle:); \`${prefix}görüşürüz @Gnarge Uyarı\` `);
...
exports.help = {
  ...
  usage: 'görüşürüz <@kullanıcı> <sebep>',
