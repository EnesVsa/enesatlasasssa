...
//YARDIM KOMUTU
  ...
  **[${prefix}yardım Genel](https://discord.gg/enDjBqKjQ5)** 
  **[${prefix}yardım Eğlence](https://discord.gg/enDjBqKjQ5)**
  **[${prefix}yardım Moderasyon](https://discord.gg/enDjBqKjQ5)**
  **[${prefix}yardım Sunucu](https://discord.gg/enDjBqKjQ5)**
  **[${prefix}yardım Sahip](https://discord.gg/enDjBqKjQ5)**
  `)
  .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=BOTUNİDSİ&scope=bot&permissions=2108157183)` + "** | **" + `[Destek Sunucusu](https://discord.gg/2vPdmYz)`  + "** | **" + `[Oy Ver](https://bit.ly/3980hKq)`  + "** | **" + `[Web Sitesi](https://gnarge.xyz/)  `, false)
...
//EnesV TARAFINDAN YAPILMIŞTIR 2021 DE YENİLENMİŞTİR!
